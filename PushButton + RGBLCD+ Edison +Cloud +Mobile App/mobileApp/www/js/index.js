...
$(document).ready(function () {
    ...
    $('#help').click(function () {
        alert("write some message that can help ");
    ...
    function recievedevent(id) {
        $.ajax({
            ...
            url: "http://localhost:3000/bitval",
            type: 'GET',
            success: recall
        })
    }
    ...
    function recall1(data1) {
        if (data1 != "none") {
            //add to the DOM
            console.log(data1);
            document.getElementById("NewThings").innerHTML += "<div class=\"col-sm-12 col-xs-12 col-lg-12\"><ul><li class=\"Open\"><div>" +data1 +"</div></li></ul></div>" ;
